...
namespace dae
{
	...
	public:
		...
		static void RenderTexture(const Texture2D& texture, glm::vec2 drawLocation, glm::vec2 srcLocation, glm::ivec2 cellSize, float width, float height, bool flipX, bool flipY, float rotation = 0);
