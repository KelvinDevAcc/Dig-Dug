...
void loadResources()
{
    ...
    ss.load_sound(16, "../Data/Sounds/12FygarFlame.mp3");


    dae::ResourceManager::LoadFont(dae::HashString("arcadeclassic"), "ARCADECLASSIC.TTF", 48);
    dae::ResourceManager::LoadFont(dae::HashString("digdug"), "DIG DUG.ttf", 48);
    dae::ResourceManager::LoadFont(dae::HashString("font"), "font.ttf", 28);
    dae::ResourceManager::LoadFont(dae::HashString("TITLE"), "font.ttf", 136);
    dae::ResourceManager::LoadFont(dae::HashString("TITLEBig"), "font.ttf", 144);
    dae::ResourceManager::LoadFont(dae::HashString("arcadeBig"), "arcade-legacy.ttf", 28);
    dae::ResourceManager::LoadFont(dae::HashString("arcade"), "arcade-legacy.ttf", 24);

    dae::ResourceManager::LoadTexture(dae::HashString("lives"),"Lives.png");
    dae::ResourceManager::LoadTexture(dae::HashString("sky"), "spritesheetMap.png", SDL_Rect(64, 0, 8, 8));
    dae::ResourceManager::LoadTexture(dae::HashString("skyFloor"), "spritesheetMap.png", SDL_Rect(64, 8, 8, 8));
	dae::ResourceManager::LoadTexture(dae::HashString("floorblock01"),"spritesheetMap.png",SDL_Rect(176,0,16,16));

	dae::ResourceManager::LoadTexture(dae::HashString("floorblock02"),"spritesheetMap.png",SDL_Rect(56,0,8,8));
	dae::ResourceManager::LoadTexture(dae::HashString("floorblock021"),"spritesheetMap.png",SDL_Rect(0,0,8,8));
	dae::ResourceManager::LoadTexture(dae::HashString("floorblock022"),"spritesheetMap.png",SDL_Rect(8,0,8,8));
	dae::ResourceManager::LoadTexture(dae::HashString("floorblock023"),"spritesheetMap.png",SDL_Rect(16,0,8,8));
	dae::ResourceManager::LoadTexture(dae::HashString("floorblock024"),"spritesheetMap.png",SDL_Rect(24,0,8,8));
	dae::ResourceManager::LoadTexture(dae::HashString("floorblock025"),"spritesheetMap.png",SDL_Rect(32,0,8,8));
	dae::ResourceManager::LoadTexture(dae::HashString("floorblock026"),"spritesheetMap.png",SDL_Rect(48,0,8,8));

	dae::ResourceManager::LoadTexture(dae::HashString("floorblock03"),"spritesheetMap.png",SDL_Rect(56,8,8,8));
    dae::ResourceManager::LoadTexture(dae::HashString("floorblock031"), "spritesheetMap.png", SDL_Rect(0, 8, 8, 8));
    dae::ResourceManager::LoadTexture(dae::HashString("floorblock032"), "spritesheetMap.png", SDL_Rect(8, 8, 8, 8));
    dae::ResourceManager::LoadTexture(dae::HashString("floorblock033"), "spritesheetMap.png", SDL_Rect(16, 8, 8, 8));
    dae::ResourceManager::LoadTexture(dae::HashString("floorblock034"), "spritesheetMap.png", SDL_Rect(24, 8, 8, 8));
    dae::ResourceManager::LoadTexture(dae::HashString("floorblock035"), "spritesheetMap.png", SDL_Rect(32, 8, 8, 8));
    dae::ResourceManager::LoadTexture(dae::HashString("floorblock036"), "spritesheetMap.png", SDL_Rect(48, 8, 8, 8));

	dae::ResourceManager::LoadTexture(dae::HashString("floorblock04"),"spritesheetMap.png",SDL_Rect(56,16,8,8));
	dae::ResourceManager::LoadTexture(dae::HashString("floorblock041"),"spritesheetMap.png",SDL_Rect(0,16,8,8));
	dae::ResourceManager::LoadTexture(dae::HashString("floorblock042"),"spritesheetMap.png",SDL_Rect(8,16,8,8));
	dae::ResourceManager::LoadTexture(dae::HashString("floorblock043"),"spritesheetMap.png",SDL_Rect(16,16,8,8));
    ...
    dae::ResourceManager::LoadTexture(dae::HashString("leftEnd"), "spritesheetDigging.png", SDL_Rect(32, 0, 16, 16));
    dae::ResourceManager::LoadTexture(dae::HashString("rightEnd"), "spritesheetDigging.png", SDL_Rect(48, 0, 16, 16));
    dae::ResourceManager::LoadTexture(dae::HashString("walkTroughUp"), "spritesheetDigging.png", SDL_Rect(64, 0, 16, 16));
    dae::ResourceManager::LoadTexture(dae::HashString("walkTroughLeft"), "spritesheetDigging.png", SDL_Rect(80, 0, 16, 16));
    dae::ResourceManager::LoadTexture(dae::HashString("UpRight"), "spritesheetDigging.png", SDL_Rect(96, 0, 16, 16));
    dae::ResourceManager::LoadTexture(dae::HashString("UpLeft"), "spritesheetDigging.png", SDL_Rect(112, 0, 16, 16));
    dae::ResourceManager::LoadTexture(dae::HashString("BottemRight"), "spritesheetDigging.png", SDL_Rect(128, 0, 16, 16));
    dae::ResourceManager::LoadTexture(dae::HashString("BottomLeft"), "spritesheetDigging.png", SDL_Rect(144, 0, 16, 16));
    dae::ResourceManager::LoadTexture(dae::HashString("MiddleBlock"), "spritesheetDigging.png", SDL_Rect(160, 0, 16, 16));


    dae::ResourceManager::LoadTexture(dae::HashString("PumpLine"), "SpriteSheetFinal.png", SDL_Rect(384, 144, 32, 16));
    dae::ResourceManager::LoadTexture(dae::HashString("PumpEnd"), "SpriteSheetFinal.png", SDL_Rect(352, 144, 32, 16));

    dae::ResourceManager::LoadTexture(dae::HashString("BreathFireStage1"), "SpriteSheetFinal.png", SDL_Rect(224, 96, 32, 32));
    dae::ResourceManager::LoadTexture(dae::HashString("BreathFireStage2"), "SpriteSheetFinal.png", SDL_Rect(256, 96, 64, 32)); // Adjust X to the right by 32 pixels
    dae::ResourceManager::LoadTexture(dae::HashString("BreathFireStage3"), "SpriteSheetFinal.png", SDL_Rect(320, 96, 96, 32)); // Adjust X to the right by 64 pixels


    dae::ResourceManager::LoadSprite(dae::HashString("Player"),
        ...
        14,   // colCount
        {
            ...
            { "Walk_Left", { { { 13, 0 }, { 12, 0 } }, 4 } },
            { "Walk_Up", { { { 0, 2 }, { 1, 2 } }, 4 } },
            { "Walk_Down", { { { 0, 1 }, { 1,1 } }, 4 } },
            { "Dying", { { { 0, 3 }, { 1, 3 }, { 2, 3 }, { 3, 3 }, { 4, 3 } }, 2 } },
            { "Attacking", { { { 4, 0 },{ 5, 0 }  }, 1 } },
            { "AttackingUp", { { { 4, 2 }, { 5, 2 } }, 1 } },
            { "Victory", { {  { 1, 0 }}, 3 } },
            { "Digging", { { { 2, 0 }, { 3, 0 }}, 3 } }
    ...
    dae::ResourceManager::LoadSprite(dae::HashString("Rock"),
        "Extra.png",
        3,  // rowCount
        16,  // colCount
        {
    ...
    dae::ResourceManager::LoadSprite(dae::HashString("enemy"),
        "SpriteSheetFinal.png",
        7,  // rowCount
        14,   // colCount
        {
    ...
    dae::ResourceManager::LoadSprite(dae::HashString("Fygar"),
        "SpriteSheetFinal.png",
        7,  // rowCount
        14,   // colCount
        {
...
void LoadStartMenu(dae::Scene* startMenuScene)
{
    ...
    unsigned int arcadeID = dae::HashString("arcade");
    ...
    auto playertextcomponent = std::make_unique<dae::TextComponent>("1UP", dae::ResourceManager::GetFont(arcadeID), SDL_Color{ 255, 0, 0, 255 }, *playerInfoTxt);
    ...
    if (numControllers > 0) {
        ...
        auto player02textcomponent = std::make_unique<dae::TextComponent>("2UP", dae::ResourceManager::GetFont(arcadeID), SDL_Color{ 255, 0, 0, 255 }, *player02InfoTxt);
    ...
    auto titleTextComponent02 = std::make_unique<dae::TextComponent>("DIG DUG", dae::ResourceManager::GetFont(TITLEBigID), SDL_Color{ 0, 0, 255, 255 }, *TitleObject02);
    ...
    auto titleTextComponent = std::make_unique<dae::TextComponent>("DIG DUG", dae::ResourceManager::GetFont(TITLEID), SDL_Color{ 247, 190, 57, 255 }, *TitleObject);
    ...
    auto menuComponent = std::make_unique<dae::MenuComponent>(menuObject.get(), options, callbacks, dae::ResourceManager::GetFont(arcadeID), 30.0f);
    ...
    auto textComponent = std::make_unique<dae::TextComponent>("NAMCOT", dae::ResourceManager::GetFont(arcadeID), SDL_Color{ 255, 0, 0, 255 }, *InfoTxt);
    ...
    auto character1textcomponent02 = std::make_unique<dae::TextComponent>("© 1982 1985 NAMCO LTD.", dae::ResourceManager::GetFont(arcadeID), SDL_Color{ 255, 255, 255, 255 }, *Infocharacter1Txt02);
    ...
    auto character2textcomponent02 = std::make_unique<dae::TextComponent>("ALL RIGHTS RESERVED", dae::ResourceManager::GetFont(arcadeID), SDL_Color{ 255, 255, 255, 255 }, *Infocharacter2Txt02);
...
void LoadScoreboard(dae::Scene* ScoreBoardScene)
{
    ...
    for (size_t i = 0; i < scores.size(); ++i) {
        ...
        auto textComponent = std::make_unique<dae::TextComponent>(text, dae::ResourceManager::GetFont(arcadeBigID), textColor, *gameObject);
    ...
    auto menuComponent = std::make_unique<dae::MenuComponent>(menuObject.get(), options2, callbacks2, dae::ResourceManager::GetFont(arcadeBigID), 70.0f);
...
void LoadUi(dae::Scene* scene)
{
    ...
    for (size_t i = 0; i < players.size(); ++i) {
        ...
        if (auto PointComponent = player->GetComponent<dae::PointComponent>())
        {
            ...
            auto pointsDisplayComponent = std::make_unique<dae::PointsDisplayComponent>(dae::ResourceManager::GetFont(arcadeID),*pointsDisplayObject);
...
void loadInputScore(dae::Scene* scene)
{
    ...
    for (int i = 0; i < GameData::GetInstance().GetNumberOfPlayers(); ++i)
    {
        ...
        std::unique_ptr<SelectNameComponent> nameInputComponent = std::make_unique<SelectNameComponent>(nameInputObject.get(), 6, dae::ResourceManager::GetFont(arcadeID), SDL_Color{ 255, 255, 255, 255 }, i);
        ...
        auto ScoreTextComponent = std::make_unique<dae::TextComponent>(std::to_string(GameData::GetInstance().GetPlayerData(i).score), dae::ResourceManager::GetFont(arcadeID), SDL_Color{ 255, 0, 0, 255 }, *ScoreObject); // Specify color here
